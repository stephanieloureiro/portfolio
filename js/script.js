(function () {
  ...
  var dict = {
    en: {
      "nav.about": "About", "nav.experience": "Experience + Education", "nav.projects": "Projects",
      ...
      "experience.bullet1": "Built and published institutional websites with attention to content structure, responsiveness, accessibility, and maintainability.",
      "experience.bullet2": "Worked with organizations connected to family farming, turning institutional needs into practical web experiences.",
    ...
    pt: {
      "nav.about": "Sobre", "nav.experience": "Experiência + Formação", "nav.projects": "Projetos",
      ...
      "experience.bullet1": "Construí e publiquei websites institucionais com atenção a estrutura de conteúdo, responsividade, acessibilidade e manutenção.",
      "experience.bullet2": "Atuei com organizações ligadas à agricultura familiar, transformando necessidades institucionais em experiências web práticas.",
  ...
  /* ============================================
     ...
     ============================================ */
  var sections = ["projects", "about", "experience", "skills", "achievements", "contact"];
