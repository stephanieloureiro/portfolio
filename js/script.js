(function () {
  ...
  var dict = {
    ...
    pt: {
      ...
      "hero.scroll": "Rolar",
      "about.heading": "Sobre",
      "about.p1": "Sou estudante de Engenharia de Software e técnica em Desenvolvimento de Sistemas pelo SENAI FIRJAN. Minha trajetória na tecnologia começou pelo design, e hoje uno programação e experiência do usuário para criar produtos funcionais, claros e bem planejados.",
      "about.p2": "Já desenvolvi e publiquei dois sites institucionais, participando de todo o processo — do levantamento de requisitos ao deploy. Também tenho experiência com projetos de robótica, hackathons e iniciativas de incentivo à presença feminina em áreas STEM.",
