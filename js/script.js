(function () {
  ...
  var dict = {
    en: {
      ...
      "journey.focus.ui": "Responsive UI",
      "journey.focus.accessibility": "Accessibility",
      "journey.focus.publishing": "Publishing",
      ...
      "projects.nexora": "ERP web system built to centralize business routines, organize operational data, and make management workflows clearer from a single interface.",
    ...
    pt: {
      ...
      "journey.focus.ui": "Interface responsiva",
      "journey.focus.accessibility": "Acessibilidade",
      "journey.focus.publishing": "Publicação",
      ...
      "projects.nexora": "Sistema ERP web criado para centralizar rotinas de negócio, organizar dados operacionais e deixar os fluxos de gestão mais claros em uma única interface.",
